...
The [Puli](https://www.gl-inet.com/products/gl-xe300/) is another 4G LTE Hotspot/TravelRouter Combo, Like the [Mundi](https://techrelay.xyz/post/digital-nomad-vpn-hardware/#mundi) it supports built in cellular and has a built it battery however unlike the Mundi it also has 2 Gigabit Ethernet ports and supports interchangeable modules like the Spitz and Spitz AX it supports CAT4 and CAT6 Modules. If you need the Ethernet and/or the interchangeable modules then you definitely want to check this one out.
